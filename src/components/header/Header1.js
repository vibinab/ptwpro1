    ...
    return (
        <>
            ...
            <Tabs >
                ...
                <Tab style={{color:"white", marginLeft:"4rem"}} label="NEWS&EVENTS" />

            
            
                <Tab style={{color:"white", marginLeft:"6rem"}} label="CAREERS" />

            
            
                <Tab style={{color:"white" ,marginLeft:"4rem", fontSize:"2rem"}}label="PTW" />
            
                <Tab style={{color:"white",marginLeft:"2rem"}}label="LAB" />


            
                <Tab style={{color:"white",marginLeft:"2rem"}} label="CONTACT&LOCATIONS " />

            
            
                <Tab style={{color:"white", marginLeft:"2rem", marginRight:"2rem"}} label="ABOUTS US" />
